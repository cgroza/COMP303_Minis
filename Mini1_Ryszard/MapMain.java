//Program name: MapMain
//Programmer: Ryszard Kubinski 260731196
//Program Date: Sept 2018
//Program Function: Gather information and use methods from Map.java to generate ASCII 2D char matrix
...
public class MapMain {
    ...
    public static void main(String[]args)
        ...
        do {System.out.println("Please input the maximum number of rows:");
        ...
        do {System.out.println("Please input the maximum number of columns:");
        ...
        if (mapObject != null)
            {System.out.println("Map has been initialized.");} //checking if we instantiated
